...
export default async function WomenPlayerProfilePage({
  params,
}: {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border bg-white p-6 shadow-sm">
        <div className="flex items-start gap-5">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-purple-100 text-purple-700 text-3xl font-bold">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 grid grid-cols-2 gap-4 sm:grid-cols-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-purple-700">{player.goals ?? '—'}</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase text-slate-500">Assists</p>
                <p className="text-sm font-semibold text-purple-700">{player.assists ?? '—'}</p>
              </div>
            </div>
          </div>
        </div>
